        ...
        <article id="credit" class="next">
            <section>
                ...
                <ul  data-bind="with : creditCardSection" class="list" ui-implements="form">
                    <li>
                            <p>Credit Card</p>
                            <input type="hidden" name="txtCardType" id="txtCardType" runat="server" value="Visa" />
                            <ul class="list select inline-radio">
                                
                                <li data-bind="click : function(){checkCardType('American Express','rdbCardType3');}" role="radio" class="">
                                ...
                                <li data-bind="click : function(){checkCardType('Visa','rdbCardType1')}" role="radio" class="">                                    
                                    <input data-bind="checked: cardType, checkedValue: 'Visa'"  type="radio" id="rdbCardType1" name="rdbCardType" runat="server" value="Visa">
                                    <h3>Visa</h3>
                                </li>
                                <li data-bind="click : function(){checkCardType('Master Card','rdbCardType2')}" role="radio" class="">
                                    <h3>MasterCard</h3>
                                    <input data-bind="checked: cardType, checkedValue: 'Master Card'" type="radio" id="rdbCardType2" name="rdbCardType" runat="server" value="MasterCard">
                                </li>
                ...
                <div class="hidden">
                    <asp:Button ID="btnFinalSubmit" runat="server" Text="Confirm Details" />
                </div>
            </section>
        </article>
    </form>
